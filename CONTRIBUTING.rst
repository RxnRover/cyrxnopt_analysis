...
Welcome to ``cyrxnopt_analysis`` contributor's guide.
...
If you experience bugs or general issues with ``cyrxnopt_analysis``, please have
a look on the `issue tracker`_. If you don't see anything useful there, please
...
You can help improve ``cyrxnopt_analysis`` docs by making them more readable and
coherent, or by adding missing information and correcting mistakes.

``cyrxnopt_analysis`` documentation uses Sphinx_ as its main documentation
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
    ...
    .. tip::
       ...
       propose changes in ``cyrxnopt_analysis``'s files. While this mechanism can
...
::
    ...
    conda create -n cyrxnopt_analysis python=3 six virtualenv pytest pytest-cov
    conda activate cyrxnopt_analysis
...
3. Clone this copy to your local disk:
   ...
   ::
       ...
       git clone git@github.com:YourLogin/cyrxnopt_analysis.git
...
5. Install |pre-commit|_:
   ...
   ``cyrxnopt_analysis`` comes with a lot of hooks configured to automatically
...
.. _issue tracker: https://github.com/<USERNAME>/cyrxnopt_analysis/issues

.. _repository: https://github.com/<USERNAME>/cyrxnopt_analysis
